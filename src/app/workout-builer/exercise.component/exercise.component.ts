...
const html = require('./exercise.component.html');
...
export class ExerciseComponent implements OnInit {
    ...
    mapFormValues(form: FormGroup) {
        ...
        this.exercise.description = form.controls['descriptions'].value;
        ...
        this.exercise.videos = form.controls['value'].value;
    }
