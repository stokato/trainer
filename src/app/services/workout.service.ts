...
export class WorkoutService {
    ...
    collectionUrl = 'https://api.mongolab.com/api/1/databases/personaltrainer/collections';
    ...
    addWorkout(workout: any) {
        ...
        workout.exercises.forEach((exercisePlan: any) => {
            workoutExercises.push({
                name: exercisePlan.exercise.name, duration: exercisePlan.duration
            })
        });
    ...
    updateWorkout(workout: WorkoutPlan) {
        ...
        let body = {
            ...
            "name": workout.name,
            "title": workout.title,
            "desription": workout.description,
            "restBetweenExercise": workout.restBetweenExercise
        };
    ...
    deleteWorkout(workoutName: string) {
        return this.http.delete(this.collectionUrl + '/workouts/' + workoutName + this.params)
            .map((res: Response) => res.json())
            .catch(WorkoutService.handleError);
    }
